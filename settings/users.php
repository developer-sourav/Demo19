					...
					<div class="table-responsive">
						<table id="example" class="table table-hover display mb-30" >
								...
								?>
                                        ...
                                        <td>
                                        	<a class="confirmdelete tabledeletebttn" title="Delete" href="<?php echo $admin_url; ?>users?action=delete&users_id=<?php echo $row['id'] ?>"><i class="fa remove_cross">&#xf00d;</i></a>
											<?php if($row['status']==0) { ?>
                                            <a title="Active" href="<?php echo $admin_url; ?>users?action=active&users_id=<?php echo $row['id'] ?>"><i class="fa fa-ban"></i></a>
                                            <?php } else { ?>
                                            <a title="Deactive" href="<?php echo $admin_url; ?>users?action=deactive&users_id=<?php echo $row['id'] ?>"><i class="fa fa-check "></i></a>
                                             <?php } ?>
                                            <a title="Edit" href="<?php echo $admin_url; ?>edit-user?user_id=<?php echo $row['id'] ?>"><i class="fa fa-edit"></i></a>
                                        </td>
                                     </tr>
								<?php } ?>
