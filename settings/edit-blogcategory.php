...
if(isset($_POST['add-submit']))
{
	...
	if($title!='')
	{
		...
		mysqli_query($connect,"Update `blogcategory` SET `title`='".$title."' where id=".$id );
...
?>
					...
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
					  <h5 class="txt-dark">Blog Categories</h5></div>
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
					  <ol class="breadcrumb">
						<li><a href="<?php echo $admin_url;?>">Dashboard</a></li>
                        <li><a href="<?php echo $admin_url;?>blog-category">Category</a></li>
...
<h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-info-outline mr-10"></i>Edit Data</h6>
							...
							<?php
						$row=mysqli_fetch_assoc(mysqli_query($connect,"select * from blogcategory where id=".$id));
						?>
