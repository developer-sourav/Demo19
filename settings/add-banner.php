...
if(isset($_POST['add-submit']))
{
  ...
  $q="Insert into banner SET seo='".$seo."', title='".$title."',subtitle='".$subtitle."',link='".$link."',button='".$button."', img='".$img_name."',status=1 ";
...
?>
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
					  <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo $admin_url;?>banner">Banners</a></li>
...
<h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-info-outline mr-10"></i>Add Data</h6>
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="subtitle" class="form-control" id="inputPass word3" placeholder=" IF Needed">
                                        </div>
                                    </div>
									...
									<div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="button" class="form-control" id="inputPass word3" placeholder="Button Name">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="inputPassword3" class="col-sm-2 col-form-label">Link</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="link" class="form-control" id="inputPass word3" placeholder=" Button Link">
                                        </div>
                                    </div>
